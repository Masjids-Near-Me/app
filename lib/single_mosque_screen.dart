              ...
              Column(
                children: [
                            ...
                            GestureDetector(
                                onTap: () async {
                                  if (getStorage.read('pinnedMasjid') != null) {
                                    print('IN ${widget.id}');
                                    print('ID 1: '+getStorage
                                        .read('pinnedMasjid')['_id']
                                        .toString());
                                    print('ID 2: '+ _mosqueData['_id'].toString());
                                    if (getStorage
                                        .read('pinnedMasjid')['_id']
                                        .toString() ==
                                      ...
                                      print('OUT-> ${widget.id}');
                                      await WonderPush.removeTag('${getStorage
                                          .read('pinnedMasjid')['_id']
                                          .toString()}');
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      width: responsiveWidth(175, context),
                      height: responsiveHeight(30, context),
                      decoration: BoxDecoration(
                        color: Color(0xFF2D2D30),
                        borderRadius: BorderRadius.circular(15),
      ...
      for (var namaz in _mosqueKeys)
        Alarm.set(
          alarmDateTime: DateTime(
              ...
              now.month,
              now.day,
              DateTime.parse(_mosqueData['timing'][namaz.toString()]
                          ['azan_time']
                      .toString())
                  .hour,
              DateTime.parse(_mosqueData['timing'][namaz.toString()]
